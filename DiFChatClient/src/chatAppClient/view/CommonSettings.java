...
public interface CommonSettings {
	...
	public int TAPPANEL_HEIGHT				 = 	410;
	...
	public String PRODUCT_NAME					= "DiF_ChatApp_Client v1.0";
	public String COMPANY_NAME					= "Yale Universtiy";
